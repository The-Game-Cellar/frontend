...
export type SetPrimaryRequest = LibraryComponents['schemas']['SetPrimaryRequest']
...
export type UserGenrePreferenceDTO = LibraryComponents['schemas']['UserGenrePreferenceDTO']
