const PLATFORM_PRIORITY = ['playstation', 'xbox', 'nintendo', 'pc', 'unknown'];
...
function pickPlatform(platforms) {
  ...
  const matched = new Set(platforms.map(classify).filter(Boolean));
...
export default function CoverFallback({ platforms }) {
